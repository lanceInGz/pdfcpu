...
import (
	...
	pdf "github.com/lanceInGz/pdfcpu/pkg/pdfcpu"
...
func validateAnnotationDictConcrete(xRefTable *pdf.XRefTable, d pdf.Dict, dictName string, subtype pdf.Name) error {
	...
	for k, v := range map[string]struct {
		...
		"GoldGrid:AddSeal": {validateAnnotationDictTrapNet, pdf.V13, true},
		"BJCA:Annot":       {validateAnnotationDictTrapNet, pdf.V13, true},
	} {
		if subtype.Value() == k {
